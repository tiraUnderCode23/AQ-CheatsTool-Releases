...
Future<void> main() async {
  ...
  // New format - Activation Key Renewal
  final message = '''🔄 *AQ CheatsTool - تجديد رمز التفعيل*

🔄 *AQ CheatsTool - Activation Key Renewal*
...
_AQ///BIMMER Team_''';
  ...
  print('Format: Activation Key Renewal\n');
  ...
  if (response.statusCode == 200) {
    ...
    print('\n📱 Check your phone for the new format!');
  } else {
